const keyMappingEN = {
  ...
  'key_p' : { isFn: false, isLock: false, eventCode: 'KeyP', char: 'p', charShift : 'P' , charCaps: 'P' },
  ...
  'key_j' : { isFn: false, isLock: false, eventCode: 'KeyJ', char: 'j', charShift : 'J' , charCaps: 'J' },
  'key_k' : { isFn: false, isLock: false, eventCode: 'KeyK', char: 'k', charShift : 'K' , charCaps: 'K' },
  'key_l' : { isFn: false, isLock: false, eventCode: 'KeyL', char: 'l', charShift : 'L' , charCaps: 'L' },
  ...
  'key_shift_left' : { isFn: true, isLock: true, eventCode: 'ShiftLeft', eventType: 'toggleShift', char: 'L. Shift', pairKey : 'key_shift_right' },
  ...
  'key_shift_right' : { isFn: true, isLock: true, eventCode: 'ShiftRight', eventType: 'toggleShift', char: 'R. Shift', pairKey : 'key_shift_left' },

  'key_ctrl_left' : { isFn: true, isLock: true, eventCode: 'ControlLeft', eventType: 'toggleControl', char: 'Ctrl', pairKey : 'key_ctrl_right' },
  'key_win_left' : { isFn: true, isLock: false, eventCode: 'MetaLeft ', eventType: 'toggleWin', char: 'WIN' , pairKey : 'key_win_right' },
  'key_alt_left' : { isFn: true, isLock: true, eventCode: 'AltLeft', eventType: 'toggleAlt', char: 'Alt' , pairKey: 'key_alt_right' },
  'key_space' : { isFn: false, isLock: false, eventCode: 'Space', eventType: 'moveUp' , char: ' ', charShift : ' ' , charCaps: ' ' },
  'key_alt_right' : { isFn: true, isLock: true, eventCode: 'AltRight', eventType: 'toggleAlt', char: 'Alt', pairKey: 'key_alt_left' },
  'key_win_right' : { isFn: true, isLock: false, eventCode: 'MetaRight ', eventType: 'toggleWin', char: 'WIN' , pairKey : 'key_win_left' },
  ...
  'key_ctrl_right' : { isFn: true, isLock: true, eventCode: 'ControlRight', eventType: 'toggleControl', char: 'Ctrl', pairKey : 'key_ctrl_left' } ,
